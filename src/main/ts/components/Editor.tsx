  ...
  private initialise = (attempts = 0) => {
    ...
    const finalInit: EditorOptions = {
      ...
      init_instance_callback: (editor) => {
        ...
        if (
          this.props.init &&
          isFunction(this.props.init.init_instance_callback)
        ) {
